...
const ProblemPage=()=>{
  ...
  // Update code when language changes
    ...
    const handleRun = async () => {
        ...
        setRunResult(null);
        try {
            const response = await axiosClient.post(`/code/run/${problemId}`, { code, language: selectedLanguage});
    ...
    const handleSubmitCode = async () => {
        ...
        try {
            const response = await axiosClient.post(`/code/submit/${problemId}`, {code:code,language: selectedLanguage});
                              ...
                              <div className="flex justify-between items-center p-4 border-b border-base-300">
                                  <div className="flex gap-2">
                                      ...
                                      ['javascript', 'java', 'cpp'].map((lang)=>(
                                          <button key={lang} className={`btn btn-sm ${selectedLanguage === lang ? 'btn-primary' : 'btn-ghost'}`} onClick={()=>handleLanguageChange(lang)}>
