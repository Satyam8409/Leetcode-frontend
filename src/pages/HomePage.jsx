...
export default function Homepage(){
    ...
    //logout functionality achieved
    const handleLogout=()=>{
        dispatch(logoutUser());
        setSolvedProblems([]); // empty solved problems on logout
    };
                ...
                <div className="flex-none gap-4">
                    <div className="dropdown dropdown-end">
                        ...
                        <ul className="mt-3 p-2 shadow menu menu-sm dropdown-content bg-base-100 rounded-box w-52">
                            ...
                            <li>{user?.role=='admin'&&(<NavLink to='/admin'><button className='hover:cursor-pointer'>admin</button></NavLink>)}</li>
                        </ul>
                    </div>
                </div>
            </nav>
